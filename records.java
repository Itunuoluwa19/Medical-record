   ...
   private ArrayList<String> date= new ArrayList<>();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Blood pressure", "Pulse rate", "Respiration rate", "Heart rate", "Temperature", "Report", "Date", "Time"
            }
        ) {
 ...
 private void clearTable() {
    ...
    private void print(){
      ...
      void setTableRecords(){
        ...
        dfm.addRow(new Object[]{blood_pressure.get(i),pulse_rate.get(i),respiration_rate.get(i), heart_rate.get(i), temperature.get(i), reports.get(i),date.get(i), time.get(i),});
         }
